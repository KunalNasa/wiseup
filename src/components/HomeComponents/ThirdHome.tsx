  ...
  return (
    <div className=' bg-white flex flex-col'>
        ...
        <div className=" lg:w-1/2 w-full flex flex-col items-center justify-center rounded-lg">
            <h2 className='mb-3 text-center text-4xl font-mitr text-gradient font-bold'>Smart Analysis</h2>
        ...
        <div className='lg:w-1/2 w-full flex flex-col justify-center lg:p-10 py-10'>
          <h2 className='lg:text-6xl text-5xl lg:text-start text-center font-mitr text-violet-600 font-bold'>
          Keep Track of Your Balance
          </h2>
          <p className='text-lg lg:w-[80%] w-full text-center lg:text-start text-gray-600 py-5'>
