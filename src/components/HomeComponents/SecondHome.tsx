  ...
  return (
    <div className=' bg-gray-50 flex flex-col'>
        ...
        <div className='lg:w-1/2 w-full flex flex-col justify-center lg:p-10 py-10'>
          <h2 className='md:text-6xl lg:text-start text-center text-5xl font-mitr text-violet-600 font-bold'>
          Monitor Your Financial Health with Ease
           
          </h2>
          <p className='text-lg lg:w-[80%] w-full lg:text-start text-center text-gray-600 py-5'>
        ...
        <div className=" lg:w-1/2 w-full flex flex-col items-center justify-center rounded-lg">
            <h2 className='mb-3 text-center text-4xl font-mitr text-gradient font-bold'>Maintain Records</h2>
